...
namespace DBFile
{
    public class SQLHelper
    {
        ...
        {
            #region 初始化连接信息
            string strConStr = System.Configuration.ConfigurationManager.AppSettings["DBConnectString"].ToString();
        ...
        public bool ExecuteSql(SqlCommand sqlCommand)
        {
            StyleConnection.Open();
            try
            {
                sqlCommand.Connection = StyleConnection;
